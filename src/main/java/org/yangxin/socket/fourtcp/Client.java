package org.yangxin.socket.fourtcp;
...
public class Client {
    ...
    private static final Integer LOCAL_PORT = 20001;
...
//
//        // 新建一份具有HTTP代理的套接字，传输数据将通过www.baidu.com:8080端转发
//        Proxy proxy = new Proxy(Proxy.Type.HTTP,
//                new InetSocketAddress(InetAddress.getByName("www.baidu.com"), 8800));
